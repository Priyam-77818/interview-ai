 ...
 * @description score a user's mock interview answer using AI.
 * @access private
 */
interviewRouter.post("/score-answer", authMiddleware.authUser, interviewController.scoreAnswerController)
